...
public class BananaList<T> implements List<T>
{
    //Members
    private T[] elements;
    ...
    public BananaList()
    {
        elements = createTypeArray(ARRAY_INCREMENT);
    }

    public BananaList(int size)
    {
        elements = createTypeArray(size);
    }

    //Methods

    /**
     * Creates an new array of type T
     *
